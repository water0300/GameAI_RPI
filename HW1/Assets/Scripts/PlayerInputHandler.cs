...
public class PlayerInputHandler : MonoBehaviour {
    ...
    private void MouseMoveEvent(InputAction.CallbackContext ctx) => _playerControl.MouseAxis = ctx.ReadValue<Vector2>();
    private void WASDEvent(InputAction.CallbackContext ctx) => _playerControl.InputAxis = ctx.ReadValue<Vector2>();
